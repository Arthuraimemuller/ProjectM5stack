...
btn_indoor = M5Btn('', x=10, y=40, w=100, h=100, bg_c=0x90EE90, text_c=0x000000, parent=None)
btn_outdoor = M5Btn('', x=110, y=40, w=100, h=100, bg_c=0x87CEEB,text_c=0x000000, parent=None)
btn_co2 = M5Btn('', x=210, y=40, w=100, h=100, bg_c=0xFFD700,text_c=0x000000, parent=None)

icon_indoor = M5Label('🏠', x=15, y=45, color=0x000000, font=FONT_MONT_18, parent=None)
icon_outdoor = M5Label('🌤', x=115, y=45, color=0x000000, font=FONT_MONT_18, parent=None)
icon_co2 = M5Label('💨', x=215, y=45, color=0x000000, font=FONT_MONT_18, parent=None)

label_indoor = M5Label('-- °C\n-- %', x=20, y=75, color=0x000000, font=FONT_MONT_14, parent=None)
label_outdoor = M5Label('-- °C', x=125, y=90, color=0x000000, font=FONT_MONT_14, parent=None)
label_co2 = M5Label('-- ppm', x=225, y=90, color=0x000000, font=FONT_MONT_14, parent=None)
