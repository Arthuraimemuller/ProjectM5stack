...
BIGQUERY_URL = "http://localhost:8080/send-to-bigquery"  # IP de ton PC
...
label_debug = M5Label('', 250, 10, 0x000000, FONT_MONT_18)
...
while True:
    ...
    # Send to BigQuery every 300s (5 minutes)
    send_counter += 100  # loop runs every 3s
    if send_counter >= 300:
