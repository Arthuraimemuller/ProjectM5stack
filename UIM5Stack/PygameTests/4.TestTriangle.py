...
# Fonts
font_small = pygame.font.Font(FONT_NAME, 14)   # taille 14 pour forecast
...
while True:
    ...
    draw_label(now, 10, 5, font_small)
    ...
    # Line 3-5: forecast centered (taille police 14)
    weekdays = get_french_weekdays()
    start_x = (WIDTH - (7 * 40)) // 2 + 10  # centrage + léger décalage à droite
    ...
    for i in range(7):
        ...
        draw_label(day, x, 170, font_small)          # police taille 14
        draw_label(f"{temp}°C", x, 190, font_small)  # police taille 14
